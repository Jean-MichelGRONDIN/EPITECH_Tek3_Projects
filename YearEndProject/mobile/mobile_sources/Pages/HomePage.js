...
import { View, Image, StyleSheet, Text, ScrollView, Switch } from 'react-native';
...
class HomePage extends React.Component {
    ...
    render() {
        ...
        tmpActReacList.forEach(elem => {
            if (elem.home === true) {
                blockList.push(
                    <View key={elem._id} style={{backgroundColor: 'white', width: 350, height: 200, marginTop: '10%'}}>
                        <Text>Action: {elem.actionname}</Text>
                        <Text>Reaction: {elem.reactionname}</Text>
